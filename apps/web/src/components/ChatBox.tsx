...
export default function ChatBox({ chat, playerId, onSend, lang }: ChatBoxProps) {
  ...
  if (!open) {
    return (
      <button
        className="fixed bottom-32 right-4 z-40 bg-amber-600 hover:bg-amber-500 text-white rounded-full p-3 shadow-lg transition-all"
  ...
  return (
    <div className="fixed bottom-32 right-4 z-40 w-72 bg-gray-900/95 backdrop-blur rounded-lg shadow-xl border border-amber-700/50 flex flex-col max-h-80">
